...
const DISABLED_CSS = "bg-blue-300 hover:bg-blue-300 cursor-wait";

export default function ({ status, x, y, ...props }: HighlightButtonProps) {
  const text =
  ...
  return (
    <HighlightButton
      ...
      disabled={noClick}
      className={clsx(
        noClick && DISABLED_CSS,
        status === ButtonStatus.Submitting && "w-40"
      )}
